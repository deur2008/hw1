...
public class GameResultFragment extends Fragment {
    ...
    public void onResume() {
        ...
        mEdtCountSet = getActivity().findViewById(R.id.edtCountSet);
        mEdtCountPlayerWin = getActivity().findViewById(R.id.edtCountPlayerWin);
        mEdtCountComWin = getActivity().findViewById(R.id.edtCountComWin);
        mEdtCountDraw = getActivity().findViewById(R.id.edtCountDraw);
