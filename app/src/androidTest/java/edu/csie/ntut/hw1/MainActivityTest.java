...
//        mRadGrp = (RadioGroup) mMainActivity.findViewById(R.id.radGrpAge);
        mRadBtnAgeRange1 = (RadioButton) mMainActivity.findViewById(R.id.ageRange1);
        mRadBtnAgeRange2 = (RadioButton) mMainActivity.findViewById(R.id.ageRange2);
        mRadBtnAgeRange3 = (RadioButton) mMainActivity.findViewById(R.id.ageRange3);
//        mTxtNumFamily = (TextView) mMainActivity.findViewById(R.id.txtNumFamily);
        mNumPkrFamily = (NumberPicker) mMainActivity.findViewById(R.id.NumberPicker);
    ...
    public void maleAgeRange1Family12() {
        ...
        assertEquals("建議："+mMainActivity.getString(R.string.not_hurry),
    ...
    public void maleAgeRange2Family5() {
        ...
        assertEquals("建議："+mMainActivity.getString(R.string.find_couple),
                mTxtSug.getText().toString());
    }
    ...
    public void femaleAgeRange1Family3() {
        ...
        assertEquals("建議："+mMainActivity.getString(R.string.get_married),
                mTxtSug.getText().toString());
    }
